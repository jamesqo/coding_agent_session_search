...
Replace CASS in place with a completely independent Claude Code and Codex search CLI using rusqlite, SQLite FTS5, semantic retrieval, fusion, and reranking.
